...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By DXTROX' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '꧁༒☬𝓓𝓧𝓣𝓡𝓞𝓧_𝓥1☬༒꧂' : process.env.BOT_NAME,
    ...
    TALKING_DXTROX: process.env.TALKING_DXTROX === undefined ? 'false' : process.env.TALKING_DXTROX,
