...
const button = {
 ...
 description: "*Hello,This is  DXTROX_V1 bot*\n\n ```please check it```",
 sections: sections,
 listType: 1
}
...
if (regex3.test(message.message)) {
    ...
    const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:AMAL SER _DX\n' // full name
            + 'ORG:DXTROX_V1;\n' // 
            + 'TEL;type=CELL;type=VOICE;waid=919714517989:+91 9714517989\n' // WhatsApp ID + phone number
            + 'END:VCARD'
await message.client.sendMessage(message.jid,{displayname: "AMAL SER _DX", vcard: vcard}, MessageType.contact)
}
    ...
    if (regex13.test(message.message)) {
        ...
        if (message.reply_message.video === false && message.reply_message.image) {
            ffmpeg(location)
                ...
                .on('end', async () => {
		    await message.client.sendMessage(message.jid,'\n *✔uploading* \n',MessageType.text);
                    await message.client.sendMessage(message.jid,fs.readFileSync('status.png'), MessageType.image ,{caption: '```GENERATED BY DXTROX_V1```'  , mimetype: Mimetype.jpg, quoted: message.data,thumbnail: White.tm_b});
            });
        return 
        }
       else (message.reply_message.video === true && message.reply_message.video) 
        ffmpeg(location)
            ...
            .on('end', async () => {
		 await message.client.sendMessage(message.jid,'\n *✔uploading* \n',MessageType.text);
                await message.client.sendMessage(message.jid,fs.readFileSync('st.mp4'), MessageType.video , {caption: '```GENERATED BY DXTROX_V1```'  , mimetype: Mimetype.mp4, quoted: message.data,thumbnail: White.tm_b});
            });
