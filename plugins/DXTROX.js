...
// EXPORTING
    ...
    Ktb.addCommand({pattern: 'ws', fromMe: false, desc : "Converts photo to sticker"}, (async (message, match) => {
...
// EXPORTING
        reply = await message.client.sendMessage(message.jid,'*꧁•⊹٭𝚄𝙿𝙻𝙾𝙰𝙳𝙸𝙽𝙶 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝚂𝚃𝙰𝚃𝚄𝚂٭⊹•꧂*',MessageType.text);
        await message.client.sendMessage(message.jid, Buffer(respovideo.data), MessageType.video, {mimetype: Mimetype.mp4, caption: '◄━━━━━━━⦁⦁ *MADE BY DXTROX_V1* ⦁⦁━━━━━━━━►',})
